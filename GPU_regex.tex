...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Number of devices used for datasets, part of figure 5 from \cite{Nourian:DemystifyingFSA}}
...
We have come to a time where the use of pattern matching has become a necessity, for example in cybersecurity where it is used to inspect internet traffic, and as the speed of the internet and the onslaught of cyber-attacks continue to increase, it is necessary that this service is effective enough. But the problem is that simply adding more processing power to ensure sufficient performance is unsustainable for both financial and environmental reasons. It is therefore necessary to continue research to improve these technologies and ensure their maximum efficiency, which will allow us to develop faster and save money and the environment.

\paragraph{Technology and people.}
All technologies have people who have driven their development from the first thought to the present day. Just as it was people like George Boole and Alan Turing who made computers possible, so regular expressions and their acceleration on graphics cards have people who have pushed the field forward, whether it is Kleene who defined regular languages or Ken Thompson who popularised them by putting them in the QED editor and B programming language.

But the name that came up most often for me while doing this work was Michela Becchi, a professor at North Carolina State University who works on accelerating pattern recognition. She has worked on the two studies most relevant to this work and many others in the field. Since she will never be as well known as those mentioned above, I would like to highlight her, at least in this part, as a person who is driving the technology forward.

\paragraph{Historical context.}
Regular expressions, originated in the mid-20th century for formal language theory. They were integrated into a POSIX standard and became an integral part of programming. Today, regular expressions are fundamental to string manipulation and text processing.

Research into the use of GPUs for regular expression matching started with the publication of \textit{Fast Exact String Matching on the GPU}, which used it for bioinformatics, many soon followed with research focusing on network detection systems. However, due to the limitations of GPUs and the algorithms of the time, the GPU solutions were inferior to other solutions. This changed not too long ago when papers such as \textit{Why GPUs are Slow at Executing NFAs and How to Make them Faster} began to publish algorithms that could rival AP and FPGAs.
